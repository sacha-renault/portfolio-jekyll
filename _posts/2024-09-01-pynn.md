---
layout: post
title: "My PyTorch / Keras Clone"
date: September 2024
tags: [project, Python, AI]
thumbnail-img: /assets/img/projects/pynn_thumb.webp
cover-img: /assets/img/projects/pynn_thumb.webp
description: "A cool way to understand what's going on behind the hood."
---
...
- **Tensors**:
  - class that wraps numpy (_or cupy for cuda usage_) for values and gradients.
  - Allow view to get slice of tensor.
- **Layers**:
  - Linear (Dense)
  - Conv2D
- **Operations**:
  - Basic : +, \*, -, / _with backward propagation_
  - Activation : tanh, relu, softmax _with backward propagation_
  - Other functions : abs, pow, log, exp _with backward propagation_
...
<img src="{{ '/assets/img/projects/cm-pynn.png' | relative_url }}"/>
<img src="{{ '/assets/img/projects/output-pynn.png' | relative_url }}"/>
...
[see more on github](https://github.com/sacha-renault/py-nn)
